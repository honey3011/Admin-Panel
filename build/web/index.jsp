...
<div class="nav-side-menu">
    <div class="brand">
      <img class="img-thumbnail" alt="Stroy Bulletin" src="img/logo.jpg" height="50px" width="50px">
      &nbsp;&nbsp;&nbsp;<b>Admin Panel</b>
    </div> 
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="service">
                    <li><a href="GetChartDetails">Demo</a></li>
                  <li>New Service 2</li>
                  <li>New Service 3</li>
                </ul>
                ...
                <ul class="sub-menu collapse" id="new">
                    <li id="user"><a href="Users.jsp">Online Users</a></li>
                  <li>All Users</li>
                </ul>
